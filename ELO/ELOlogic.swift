...
//        for i in 0..<nSkills {
//            let x = Double.random(in: (0.48 - Double(nSkills) * 0.04 + Double(nSkills - i) * 0.08)...(0.52 - Double(nSkills) * 0.04 + Double(nSkills - i) * 0.08))
//            self.skills.append(x)
//        }
        self.skills = (0..<nSkills).map { _ in .random(in: 0.48...0.52) }
        self.m = (0..<nSkills).map {_ in 0 }
        self.v = (0..<nSkills).map {_ in 0 }
    }
}
